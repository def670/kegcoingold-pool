...
* 08 Mar 2019 - Updated for use with KegCoin Gold
---
...
* Cryptonight (Original, Monero v7, Stellite v7)
* Cryptonight Light (Original, Aeon v7, IPBC)
* Cryptonight Heavy (Sumokoin)
* Cryptonight Turtle
* Cryptonight Turtle Light

These instructions assume 3 things:
* You are using Ubuntu 16.04 or greater
...
* http://keg-pool.twisted-networks.com/
...
#### Requirements
 ...
 - [x]  [Node.js](http://nodejs.org/) v4.0+ 
		 (Use Node 8 as Node 10 breaks on NPM Update)
		 
 ```
  curl -sL https://deb.nodesource.com/setup_8.x | sudo -E bash
  sudo apt-get install -y nodejs
```
 - [x] [Redis](http://redis.io/) key-value store v2.6+ 
 ...
 - [x] libssl required for the node-multi-hashing module

   `sudo apt-get install libssl-dev`

 - [x] Boost is required for the cryptoforknote-util module
...
/* Set Cryptonight algorithm settings.
   ...
   Supported variants for "cryptonightlite": 0 (Original), 1 (Aeon v7), 2 (IPBC)
   Supported blob types: 0 (Cryptonote), 1 (Forknote v1), 2 (Forknote v2), 3 (Cryptonote v2 / Masari) */
"cnAlgorithm": "cryptonightlite",
"cnVariant": 1,
"cnBlobType": 2,
...
"poolServer": {
    ...
    "poolAddress": "KjH5BqNbdJ9SCFrKo9hF2GF6H343JezjGdh3xWGzzcEBPGbBsbHq2uhN5d9b85ruMVeQQ6ydcZGs7SSaLGZu22qSB8ajivk",
...
"payments": {
    ...
    "minPayment": 500000, // Miner balance required before sending payment
